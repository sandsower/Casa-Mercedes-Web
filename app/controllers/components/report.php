 ...
 */
	function save_report()
	{
		...
		if(!is_dir($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path))
		{ 
			mkdir($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path);
		}

		$file_name = $this->report_name.".php"; 
		$handle = fopen($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path.$file_name, 'w');
 ...
 */
	function existing_reports() 
	{
		...
		$handler = opendir($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path);
 ...
 */
	...
	{
		//Pull file
		require($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path.$report);
 ...
 */
	...
	{
		unlink($_SERVER['DOCUMENT_ROOT'].'/Casa-Mercedes-Web'.$this->path.$report);
	}
